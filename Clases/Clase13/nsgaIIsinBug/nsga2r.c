...
/** Inicialización "a mano" **/

/**
	parent_pop[0].ind[0].xreal[0] = 32.0;
	parent_pop[0].ind[0].xreal[1] =  3.0;
	parent_pop[0].ind[0].xreal[2] = 42.0;
	parent_pop[0].ind[0].xreal[3] = 15.0;
	parent_pop[0].ind[0].xreal[4] =  8.0;
**/


/**
	parent_pop[0].ind[1].xreal[0] = 9.0;
	parent_pop[0].ind[1].xreal[1] = 8.0;
	parent_pop[0].ind[1].xreal[2] = 60.0;
	parent_pop[0].ind[1].xreal[3] = 6.0;
	parent_pop[0].ind[1].xreal[4] = 2.0;

	parent_pop[0].ind[2].xreal[0] = 9.0;
	parent_pop[0].ind[2].xreal[1] = 3.0;
	parent_pop[0].ind[2].xreal[2] = 17.0;
	parent_pop[0].ind[2].xreal[3] = 2.0;
	parent_pop[0].ind[2].xreal[4] = 2.0;
**/
